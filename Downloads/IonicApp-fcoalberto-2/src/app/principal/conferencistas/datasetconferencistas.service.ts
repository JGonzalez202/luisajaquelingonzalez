...
export class DatasetconferencistasService {
 lista_conferencistas =[ {
  ...
  },
  {
    ...
    titulo :"Dra. GRISELDA CORTÉZ BARRERA",
    horario : "De 12:00:00 hrs. a 18:00:00 hrs.",
    descripcion : ""
  },
  {
  ...
  constructor() { }
  obtenerdatosConferencistas(){ 
    return this.lista_conferencistas;
  }
obtenerid(id:number){
  return this.lista_conferencistas[id];
}
